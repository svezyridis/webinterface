...
<% List<Map> availableSystems = Configuration.getAvailableAs();%>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-8 col-md-offset-2">
					...
					<p> You can register using any of the following Authentication Service providers:</p>
					<%
						for (Map system : availableSystems) {
					%>
					<p>Register with:
					<a href=<%=system.get("registerurl").toString() %> text="sometext"><%=system.get("name").toString() %></a>
					</p>
				<%} %>				
				</div>
